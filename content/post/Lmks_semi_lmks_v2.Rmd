...
plot(c(1, dim(oo)[2]), c(1, dim(oo)[1]), type ='n', xlab = "", ylab = "") #generate graph axes
a<-rasterImage(oo, 0, 0, dim(oo)[2], dim(oo)[1]) 
```

<center>
![Figure 1. Illustration of the 16 landmarks (yellow spheres) and 144 semi-landmarks (red spheres) used in this study. The numbers of the 16 fixed landmarks and eight semi-landmark curves (C1-C8) are also plotted](Fig1_png.png){ width=50% }
