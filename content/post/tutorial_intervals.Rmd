...
Below you will find all the necessary steps to obtain the desired number of interval variables and to carry out a PCA using them. In the provided example, four armadillo mandibles will be analysed which correspond to some of the individuals that were analysed in the paper where the Intervals’ method was introduced for the first time.
...
The R scripts and data files to run the method outlined below can be download from https://figshare.com/articles/intervals-method-files_rar/12025866
